// src/main.js
/**
 * Main entry point for AdvancedCryptoGateway application
 */
...
class AdvancedCryptoGateway {
    /**
     * Create a new AdvancedCryptoGateway instance
...
module.exports = AdvancedCryptoGateway;
...
if (require.main === module) {
    ...
    const app = new AdvancedCryptoGateway({
        input: args.input,
        output: args.output,
